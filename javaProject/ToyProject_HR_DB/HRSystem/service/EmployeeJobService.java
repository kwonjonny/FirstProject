...
public class EmployeeJobService {
	...
	public EmployeeJobService(EmployeesDAO employeesDAO, JobsDAO jobsDAO,
	...
	public void updateJobsAndEmployees(String jobs_id, Jobs newJobs, String name, Employees newEmployees,
		...
		try {
			...
			jobHistoryDAO.historyUpdateById(conn, employee_id, jobs_id, newJobHistory);
			conn.commit();
	...
	// JobsEmployeeService 클래스에서는 JobDAO EmployeesDAO를 사용하여 Jobs와 Employees를 update
	// 하는 메소드를 구현
	public void deleteJobsAndEmployees(String jobs_id, String name, String employee_id) throws SQLException {
		Connection conn = null;
