...
<select > <option ${year == 1999 ? 'selected' : ''}>1999</option>
				  <option ${year == 2000 ? 'selected' : ''}>2000</option>
				  <option ${year == 2001 ? 'selected' : ''}>2001</option>
</select>

<c:choose><c:when test="${param.sel == 'a' }"><h3> a를 선택했습니다.</h3></c:when>

<c:when test="${param.sel == 'b' }"><h3> b를 선택했습니다.</h3></c:when>

<c:when test="${param.sel == 'c' }"><h3>c를 선택했습니다.</h3></c:when>
